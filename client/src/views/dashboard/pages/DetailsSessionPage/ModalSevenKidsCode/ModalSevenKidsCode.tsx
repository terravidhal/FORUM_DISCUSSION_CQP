...
const ModalSevenKidsCode = forwardRef<HTMLDivElement, ModalSevenKidsCodeProps>(
  ({ name, linkVerif, dateOfCertif, course,  }, ref) => {
    return (
      <div className="ModalSevenKidsCode bg-white p-3">
          ...
          <div className="pm-certificate-border col-xs-12">
            ...
            >
              <div className="pm-certificate-title cursive col-xs-12 text-center">
                <h2>Seven kids code Private Certificate of Completion</h2>
              </div>
              <span
                style={{
                  width: "190px",
...
export default ModalSevenKidsCode;
