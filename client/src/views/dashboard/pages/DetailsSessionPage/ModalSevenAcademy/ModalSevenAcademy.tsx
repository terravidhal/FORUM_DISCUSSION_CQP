...
const ModalSevenAcademy = forwardRef<HTMLDivElement, ModalSevenAcademyProps>(
  ({ name, linkVerif, dateOfCertif, course,  }, ref) => {
    return (
      <div  className="ModalSevenAcademy bg-white p-3">
...
export default ModalSevenAcademy;
