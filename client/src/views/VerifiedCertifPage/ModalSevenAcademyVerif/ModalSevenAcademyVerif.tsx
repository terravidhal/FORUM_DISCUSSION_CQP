import "./ModalSevenAcademyVerif.css";
import { forwardRef } from "react";
import QRCode from "react-qr-code";

interface ModalSevenAcademyProps {
  name: string;
  linkVerif: string;
  course: string;
...
const ModalSevenAcademyVerif = forwardRef<HTMLDivElement,ModalSevenAcademyProps>(({ name, linkVerif, dateOfCertif, course }, ref) => {
  return (
    <div className="ModalSevenAcademyVerif bg-white p-3">
            ...
            <div className="pm-certificate-border col-xs-12">
              ...
              >
                <div className="pm-certificate-title cursive col-xs-12 text-center">
                  <h2>SevenGps Private Enterprise Certificate of Completion</h2>
                </div>
                <span
                  style={{
                    width: "190px",
...
export default ModalSevenAcademyVerif;
